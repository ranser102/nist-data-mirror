...
public class NistDataMirror {
    ...
    private static final String CVE_JSON_10_MODIFIED_URL = "https://<proxy url>/NVD-Proxy/1.0/nvdcve-1.0-modified.json.gz";
    private static final String CVE_JSON_10_BASE_URL = "https://<proxy url>/NVD-Proxy/1.0/nvdcve-1.0-%d.json.gz";
    private static final String CVE_MODIFIED_10_META = "https://<proxy url>/NVD-Proxy/1.0/nvdcve-1.0-modified.meta";
    private static final String CVE_BASE_10_META = "https://<proxy url>/NVD-Proxy/1.0/nvdcve-1.0-%d.meta";

    private static final String CVE_JSON_11_MODIFIED_URL = "https://<proxy url>/NVD-Proxy/1.1/nvdcve-1.1-modified.json.gz";
    private static final String CVE_JSON_11_BASE_URL = "https://<proxy url>/NVD-Proxy/1.1/nvdcve-1.1-%d.json.gz";
    private static final String CVE_MODIFIED_11_META = "https://<proxy url>/NVD-Proxy/1.1/nvdcve-1.1-modified.meta";
    private static final String CVE_BASE_11_META = "https://<proxy url>/NVD-Proxy/1.1/nvdcve-1.1-%d.meta";
    ...
    private void doDownload(String nvdUrl) throws MirrorException {
        ...
        if (file != null && success) {
            ...
            if (file.getName().endsWith(".gz")) {
                uncompress(file); //TODO: need to check if we need that step
            }
            System.out.println("[EranSery] Now deleting file " + file.getName());
            file.delete();
        }
    }
    ...
    private void uncompress(File file) {
        ...
        try {
            ...
            System.out.println("[EranSery] Now deleting file " + outputFile.getName());
            outputFile.delete();
